...
import com.zxh.kcsj.sh.service.UsersService;
...
@RestController
@RequestMapping(value = "/UserSH")
public class UsersControllerSH {
    private final UsersService usersService;

    public UsersControllerSH(UsersService usersService) {
