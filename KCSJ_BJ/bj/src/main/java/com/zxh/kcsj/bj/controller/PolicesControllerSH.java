...
@RestController
@RequestMapping(value = "/PoliceSH")
public class PolicesControllerSH {
    @Reference(version = "1.0.0", url = "dubbo://47.103.40.121:20881")
    private final service.PolicesService policesService;

    public PolicesControllerSH(PolicesService policesService) {
